    ...
    <div>
        ...
        <el-card class="box-card">
            ...
            <!-- 分配角色 -->
             <el-dialog
                title="分配角色"
                :visible.sync="setRoleDalogVisible" @close="setRoleDialogClose"
                width="30%">
                <div>
                ...
                <span slot="footer" class="dialog-footer">
                    <el-button @click="setRoleDalogVisible = false">取 消</el-button>
...
export default {
    ...
    methods:{
        ...
        async saveRoleInfo(){
            ...
            this.getUserList();
            this.setRoleDalogVisible = false;
        }
    }
}
</script>
